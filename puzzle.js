...
знания0 = new И()
знания0.добавить(new Эквивалентность(АРыцарь,new Не(АЛжец)))// Добавьте
...
знания2.добавить(new Эквивалентность(new Или(new И(АРыцарь, БРыцарь),new И(АЛжец, БЛжец)), АРыцарь)) // Добавьте
...
// В сказал: "А - рыцарь."
знания3 = new И()
знания3.добавить(new Эквивалентность(АРыцарь, new Не(АЛжец)))    // Добавьте
